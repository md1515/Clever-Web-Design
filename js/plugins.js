...
(function($){
    $.fn.jCollapse = function(options) {
        var defaults = {
            expand_text: "Show content",
            collapse_text: "Hide content",
			effect: "fade"
        };
        var options = $.extend(defaults, options);
